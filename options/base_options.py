...
class BaseOptions():
    ...
    def gather_options(self, args_string=None):
        ...
        self.parser = parser
        return parser.parse_args(args_string)
    ...
    def parse(self, args_string=None):
        """Parse our options, create checkpoints directory suffix, and set up gpu device."""
        opt = self.gather_options(args_string=args_string)
